...
HouseStyleReader::HouseStyleReader(
    ...
    : WrapExpat(encoding, true), ud(new HouseStyleReaderData()) {
...
void XMLCALL HouseStyleReader::start(void *data, const XML_Char *el,
                                     const XML_Char **attr) {
...
void XMLCALL HouseStyleReader::characterdata(void *data, const XML_Char *s,
                                             int len) {
  HouseStyleReaderData *ud;
  ud = (HouseStyleReaderData *)data;
