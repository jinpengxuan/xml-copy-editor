...
XmlSuppressProdnote::XmlSuppressProdnote(bool parseDeclaration,
...
void XMLCALL XmlSuppressProdnote::xmldeclhandler(void *data,
...
void XMLCALL XmlSuppressProdnote::defaulthandler(void *data, const XML_Char *s,
                                                 int len) {
  SuppressProdnoteData *d;
  d = (SuppressProdnoteData *)data;
  if (!(d->skip))
...
void XMLCALL XmlSuppressProdnote::start(void *data, const XML_Char *el,
                                        const XML_Char **attr) {
