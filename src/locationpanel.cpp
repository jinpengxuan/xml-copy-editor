...
LocationPanel::LocationPanel(wxWindow *parentWindowParameter, int id)
  ...
  structureEdit =
      new wxStyledTextCtrl(this, wxID_ANY, wxDefaultPosition, wxDefaultSize);
  for (int i = 0; i < 3; i++)
...
void LocationPanel::update(XmlDoc *doc, const wxString &parentParameter) {
...
void LocationPanel::OnSysColourChanged(
