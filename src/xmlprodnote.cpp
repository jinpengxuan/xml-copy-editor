...
XmlProdnote::XmlProdnote(bool parseDeclaration, bool expandInternalEntities,
                         size_t size)
    : d(new ProdnoteData()) {
...
void XMLCALL XmlProdnote::xmldeclhandler(void *data, const XML_Char *version,
...
void XMLCALL XmlProdnote::defaulthandler(void *data, const XML_Char *s,
                                         int len) {
  ProdnoteData *d;
  d = (ProdnoteData *)data;
...
void XMLCALL XmlProdnote::start(void *data, const XML_Char *el,
                                const XML_Char **attr) {
  ProdnoteData *pd;
