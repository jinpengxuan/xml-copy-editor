...
XmlAssociateDtd::XmlAssociateDtd(const XmlTextInfo &info, const wxString &path,
                                 const wxString &publicID, const char *encoding,
                                 size_t size)
    : WrapExpat(encoding), d(new DtdData()), mInfo(info) {
...
void XMLCALL XmlAssociateDtd::defaulthandler(void *data, const XML_Char *s,
                                             int len) {
...
void XMLCALL XmlAssociateDtd::start(void *data, const XML_Char *el,
                                    const XML_Char **attr) {
  XmlAssociateDtd *pThis = (XmlAssociateDtd *)data;
  DtdData *d = pThis->d.get();
...
void XMLCALL XmlAssociateDtd::startdoctypehandler(void *data,
