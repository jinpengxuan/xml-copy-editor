...
string HouseStyleWriter::getOutput() { return hswd->output; }

void XMLCALL HouseStyleWriter::start(void *data, const XML_Char *el,
                                     const XML_Char **attr) {
...
void XMLCALL HouseStyleWriter::characterdata(void *data, const XML_Char *s,
                                             int len) {
  HouseStyleWriterData *hswd;
  hswd = (HouseStyleWriterData *)data;
...
void XMLCALL HouseStyleWriter::xmldecl(void *data, const XML_Char *version,
...
void XMLCALL HouseStyleWriter::defaulthandler(void *data, const XML_Char *s,
                                              int len) {
  HouseStyleWriterData *hswd;
  hswd = (HouseStyleWriterData *)data;
...
void HouseStyleWriter::modify(vector< ContextMatch > &v, string &buffer,
