...
#define XHTML_START                                                            \
  ...
  "xmlns=\"http://www.w3.org/1999/xhtml\"><head><title>XML Copy Editor "       \
  "report</title><meta http-equiv=\"Content-Type\" content=\"text/html\" "     \
  "charset=\"UTF-8\"/><style type=\"text/css\"><!-- body, h1, h2, h3, h4, "    \
  "th, td { font-family: \"Arial\", \"Helvetica\", sans-serif; } table { "     \
  "border-collapse: collapse; } th { text-align: left; font-size: smaller; "   \
  "padding-left: 5px; padding-right: 5px; } td { border-width: 1px; "          \
  "border-style: solid; border-color: gray; font-size: smaller; "              \
  "padding-left: 5px; padding-right: 5px; } --></style></head>"
...
public:
  StyleDialog(wxWindow *parent, wxIcon icon,
...
#ifdef __WXMSW__
              const wxString &aspellDataPath, const wxString &aspellDictPath,
#endif
              int type = ID_TYPE_STYLE, bool readOnlyParameter = false,
...
private:
  ...
  static bool elementAndOffsetCompareFunction(ContextMatch m1, ContextMatch m2);
