...
WrapTempFileName::WrapTempFileName(wxString hint, wxString extension) {
  ...
  if (myTempFileName == hint || myTempFileName.empty()) {
...
wxString WrapTempFileName::wideName() { return myTempFileName; }
...
wxString WrapTempFileName::originalWideName() { return myTempFileNameOriginal; }
...
void WrapTempFileName::setKeepFiles(bool b) { keepFiles = b; }
