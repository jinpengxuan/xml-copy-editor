...
XmlEncodingSpy::XmlEncodingSpy(const char *encoding)
    : WrapExpat(encoding), d(new EncodingData()) {
...
void XMLCALL XmlEncodingSpy::xmldeclhandler(void *data, const XML_Char *version,
...
void XMLCALL XmlEncodingSpy::start(void *data, const XML_Char *el,
                                   const XML_Char **attr) {
  EncodingData *d;
  d = (EncodingData *)data;
