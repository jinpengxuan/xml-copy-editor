...
XmlUtf8Reader::XmlUtf8Reader(bool parseDeclaration, bool expandInternalEntities,
                             size_t size)
    : d(new UtfData()) {
...
void XMLCALL XmlUtf8Reader::xmldeclhandler(void *data, const XML_Char *version,
...
void XMLCALL XmlUtf8Reader::defaulthandler(void *data, const XML_Char *s,
                                           int len) {
  UtfData *d;
  d = (UtfData *)data;
