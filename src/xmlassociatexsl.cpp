...
XmlAssociateXsl::XmlAssociateXsl(const XmlTextInfo &info, const wxString &path,
                                 const char *encoding, size_t size)
    : WrapExpat(encoding), d(new XslData()), mInfo(info) {
...
void XMLCALL XmlAssociateXsl::defaulthandler(void *data, const XML_Char *s,
                                             int len) {
...
void XMLCALL XmlAssociateXsl::start(void *data, const XML_Char *el,
                                    const XML_Char **attr) {
  XmlAssociateXsl *pThis = (XmlAssociateXsl *)data;
  XslData *d = pThis->d.get();
...
void XMLCALL XmlAssociateXsl::processinghandler(void *data,
