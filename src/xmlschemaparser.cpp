...
XmlSchemaParser::XmlSchemaParser(PromptGeneratorData *data,
                                 const char *encoding, bool nameSpaceAware)
    : WrapExpat(encoding, nameSpaceAware), d(new SchemaParserData) {
  d->promptData = data;
...
void XMLCALL XmlSchemaParser::starthandler(void *data, const XML_Char *el,
                                           const XML_Char **attr) {
  SchemaParserData *d;
